...
import org.gwtproject.tutorial.client.cssresource.CssExample;
import org.gwtproject.tutorial.client.dataresource.DataExample;
import org.gwtproject.tutorial.client.imageresource.ImageExample;
import org.gwtproject.tutorial.client.intro.IntroPanel;
import org.gwtproject.tutorial.client.textresource.TextExample;
...
/**
 * The template example panel, built for UiBinder instance (see Chapter X) This
 * is just a convenient way to display the frame for our examples; for the
 * examples code, you should look in the relevant package - in this case
 * 
 * ch03.client.history for the History example ch03.client.layout for the Layout
 * example
 * 
 * (the ch03.client.intro package contains the introduction screen you see when
...
public class ExamplePanel extends Composite {
	...
	/**
	 * The HistoryExample widget that shows how history is handled in a GWT
	 * application
	 */
	private DataExample dataExample;

	/**
	 * The LayoutExample widget that shows how GWT can use Layout Panels for screen
	 * rendering
	 */
	...
	/**
	 * The EntryPoint. Binds the UiBinder code and creates the widget to be shown.
	 * Adds a ResizeHandler to manage and resize events of the browser that are
	 * created Sets up the IntroPanel as the first widget shown to the user.
	 */
	public ExamplePanel() {
	...
	/**
	 * Helper method for showing history panel. Called when the history button is
	 * clicked in this widget, or if the user initiates it via a history token in
	 * the URL (clicks back/forward, or arrives at
	 * http://.......Example.html#history
	 */
